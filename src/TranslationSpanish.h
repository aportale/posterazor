...
#define SPANISH_POSTERAZORHELPSTEPTITLENOHTML04           "Definir el tamaño final del póster"
#define SPANISH_POSTERAZORHELPSTEPTITLE04                 "Definir el tama&ntilde;o final del p&oacute;ster"
...
#define SPANISH_POSTERAZORHELPWHYPDFOUTPUT                "&iquest;Por qu&eacute; un PDF de salida?"
