	...
	<body>
		<div id="page">
			...
			<div id="navigation">
				...
				<ul><li><a href="http://sourceforge.net"><img src="http://sourceforge.net/sflogo.php?group_id=141842&amp;type=1" width="88" height="31" alt="SourceForge.net Logo" /></a></li><li><a href="http://validator.w3.org/check?uri=referer"><img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" /></a></li></ul>
			</div>
			<div id="content">
<?=writeContent();
?>
