...
#define POSTERAZORHELPANCHORMANUALSTEP01 "manualstepone"
#define POSTERAZORHELPANCHORMANUALSTEP02 "manualsteptwo"
#define POSTERAZORHELPANCHORMANUALSTEP03 "manualstepthree"
...
#define POSTERAZORHELPENDLINE "\012"
...
"<HTML>" POSTERAZORHELPENDLINE \
	"<BODY>" POSTERAZORHELPENDLINE \
		...
		"<H2>Contents</H2>" POSTERAZORHELPENDLINE \
		...
		"<A name=\"" POSTERAZORHELPANCHORABOUT "\"><H2>About</H2></A>" POSTERAZORHELPENDLINE \
		...
		"<A name=\"" POSTERAZORHELPANCHORMANUAL "\"><H2>Manual</H2></A>" POSTERAZORHELPENDLINE \
		...
		"<A name=\"" POSTERAZORHELPANCHORMANUALSTEP01 "\"><H2>Step 1: " POSTERAZORHELPSTEPTITLE01 "</H2></A>" POSTERAZORHELPENDLINE \
		...
		"<A name=\"" POSTERAZORHELPANCHORMANUALSTEP02 "\"><H2>Step 2: " POSTERAZORHELPSTEPTITLE02 "</H2></A>" POSTERAZORHELPENDLINE \

		"<A name=\"" POSTERAZORHELPANCHORMANUALSTEP03 "\"><H2>Step 3: " POSTERAZORHELPSTEPTITLE03 "</H2></A>" POSTERAZORHELPENDLINE \

		"<A name=\"" POSTERAZORHELPANCHORMANUALSTEP04 "\"><H2>Step 4: " POSTERAZORHELPSTEPTITLE04 "</H2></A>" POSTERAZORHELPENDLINE \

		"<A name=\"" POSTERAZORHELPANCHORMANUALSTEP05 "\"><H2>Step 5: " POSTERAZORHELPSTEPTITLE05 "</H2></A>" POSTERAZORHELPENDLINE \
