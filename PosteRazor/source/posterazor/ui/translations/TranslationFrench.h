...
public:
	...
	const char* ColorType(void)                       {return "Représentation des couleurs :";}
	...
	const char* HelpHtml(void)
	{
		return	"<HTML>" POSTERAZORHELPENDLINE \
				"<BODY>" POSTERAZORHELPENDLINE \
					"<A name=\"" POSTERAZORHELPANCHORTOP "\"><CENTER><H1>PosteRazor 1.1 Help</H1></CENTER></A>" POSTERAZORHELPENDLINE \
					...
					POSTERAZORHELPINDENTATION "PosteRazor coupe une grande image en plusieurs pi&egrave;ces qui peuvent &ecirc;tre imprim&eacute;es plus facilement. Ces morceaux sont ensuite assembl&eacute;s pour former un poster. Le format de l'image initiale doit &ecirc;tre compatible avec les formats <A href=\"#" POSTERAZORHELPANCHORMANUALSTEP01 "\">suivants</A>. Au lieu de directement imprimer le poster, PosteRazor cr&eacute;&eacute; un fichier PDF de plusieurs pages qui contient les morceaux &agrave; imprimer.<br>" POSTERAZORHELPENDLINE \
					"Ce programme est libre (licence GNU GPL). Il r&eacute;utilise du code libre d'<a href=\"#" POSTERAZORHELPANCHORCODEFROMTHIRDPARTIES "\">autres projets</a> pour fonctionner. " POSTERAZORHELPENDLINE \
					"Le site web de PosteRazor est heberg&eacute; sur <b>posterazor.sourceforge.net</b>." POSTERAZORHELPENDLINE \

					POSTERAZORHELPSECTIONHEADER(POSTERAZORHELPANCHORMANUAL, FRENCH_POSTERAZORHELPMANUAL) \
					POSTERAZORHELPINDENTATION "PosteRazor est organis&eacute; &agrave; la mani&egrave;re d'un assistant. La cr&eacute;ation d'un poster est r&eacute;alis&eacute;e en 5 &eacute;tapes. Les boutons <b>Pr&eacute;c&eacute;dent</b> et <b>Suivant</b> permettent de naviguer facilement entre ces &eacute;tapes.<br>" POSTERAZORHELPENDLINE \
					...
					"<UL>" POSTERAZORHELPENDLINE \
					"<LI><b>Unit&eacute; de mesure :</b> permet de choisir l'unit&eacute; de mesure qui sera utilis&eacute; dans PosteRazor. Quand l'unit&eacute; est chang&eacute;e, toutes les valeurs pr&eacute;enregistr&eacute;es sont automatiquement converties.</LI>" POSTERAZORHELPENDLINE \
					...
					"<LI><b>Pr&eacute;visualisation OpenGL :</b> Permet d'utiliser (ou non) OpenGL pour pr&eacute;visualiser le poster. Cela permet un affichage plus net. Habituellement, cela ralenti l'affichage sur les machines plus anciennes. Si PosteRazor devient lent et ne r&eacute;ponds plus, essayez de d&eacute;sactiver cette option.</LI>" POSTERAZORHELPENDLINE \
					"</UL>" POSTERAZORHELPENDLINE \
					...
					"M&ecirc;me si votre imprimante n'impose pas de marges, il est toujours utile d'en mettre, afin de permettre de coller les diff&eacute;rents morceaux entre eux." POSTERAZORHELPENDLINE \
					...
					POSTERAZORHELPINDENTATION "Pour d&eacute;terminer la taille final du poster, il existe trois m&eacute;thodes :<br>" POSTERAZORHELPENDLINE \
					"<UL>" POSTERAZORHELPENDLINE \
					...
					"<LI><b>Taille en pourcentage :</b> Vous choisissez un pourcentage de zoom en fonction de la r&eacute;solution d'origine de l'image. La r&eacute;solution d'origine est calcul&eacute; en fonction de la taille (hauteur / largeur) et du nombre de pixels par centim&egrave;tres (ou DPI, nombre de pixels par pouces).</LI>" POSTERAZORHELPENDLINE \
					"</UL>" POSTERAZORHELPENDLINE \
					...
					"Le bouton <b>Position de l'image</b> permet de r&eacute;gler la position de l'image par rapport au papier. L'image peut &ecirc;tre centr&eacute; ou coll&eacute; sur un des bords." POSTERAZORHELPENDLINE \
					...
					"<LI><b>FreeImage</b> est utilis&eacute; pour g&eacute;rer les images. Il permet leur gestion sans soucis, tout en &eacute;tant multi plateforme. <a href=\"http://freeimage.sourceforge.net/\">Site web de FreeImage</a></LI>" POSTERAZORHELPENDLINE \
