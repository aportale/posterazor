...
#define ITALIAN_POSTERAZORHELSTEP                     "Step"

#define ITALIAN_POSTERAZORHELPABOUT                   "About the PosteRazor"
#define ITALIAN_POSTERAZORHELPMANUAL                  "Manual"
#define ITALIAN_POSTERAZORHELPSETTINGS                "Settings"
#define ITALIAN_POSTERAZORHELPSTEPTITLE01             "Load an input image"
#define ITALIAN_POSTERAZORHELPSTEPTITLE02             "Define the printer paper format"
#define ITALIAN_POSTERAZORHELPSTEPTITLE03             "Define the image tile overlapping"
#define ITALIAN_POSTERAZORHELPSTEPTITLE04             "Define the final poster size"
#define ITALIAN_POSTERAZORHELPSTEPTITLE05             "Save the Poster"
#define ITALIAN_POSTERAZORHELPINPUTFILEFORMATS        "Supported input image files"
#define ITALIAN_POSTERAZORHELPWHYPDFOUTPUT            "Why a PDF output?"
#define ITALIAN_POSTERAZORHELPCODEFROMTHIRDPARTIES    "Code from third parties"
#define ITALIAN_POSTERAZORHELPLICENSE                 "License"
