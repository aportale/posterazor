...
public:
	...
	const char* inputImage(void)                      {return "Origineelafbeelding";}
...
#define DUTCH_POSTERAZORHELPSTEPTITLE01               "Kies een origineelafbeelding"
#define DUTCH_POSTERAZORHELPSTEPTITLE02               "Papierafmeting definiëren"
#define DUTCH_POSTERAZORHELPSTEPTITLE03               "Overlapping definiëren"
#define DUTCH_POSTERAZORHELPSTEPTITLE04               "Postergrootte definiëren"
...
#define DUTCH_POSTERAZORHELPLICENSE                   "Licentie"
	...
	const char* stepTitle02(void)                     {return DUTCH_POSTERAZORHELPSTEPTITLE02;};
	const char* stepTitle03(void)                     {return DUTCH_POSTERAZORHELPSTEPTITLE03;};
	const char* stepTitle04(void)                     {return DUTCH_POSTERAZORHELPSTEPTITLE04;};
	...
	const char* helpHtml(void)
	{
		return	"<HTML>" POSTERAZORHELPENDLINE \
				"<BODY>" POSTERAZORHELPENDLINE \
					...
					POSTERAZORHELPINDENTATION "Kies een origineelafbeelding door op de open map te klikken en te zoeken naar de plaats van het origineel, of maak gebruik van \"Drag and Drop\". Sleep dan het origineelbestand naar de PosteRazor. Dit \"Drag and Drop\" principe werkt ook bij de andere functies binnen PosteRazor.<br>" POSTERAZORHELPENDLINE \
					...
					POSTERAZORHELPINDENTATION "Kies het papierformaat dat gebruikt wordt in de printer. Standaardafmetingen kunnen bij voorbaat al aangeklikt worden in het <b>Formaat</b> venster, evenals de <b>Oriëntatie</b> in de lengte of breedte. Eventueel kan een afwijkend formaat gebruikt worden bij de keuze <b>Op maat</b>. (Stuur anders even een email als een bepaalde standaardmaat hier niet bij staat)." POSTERAZORHELPENDLINE \
					...
					POSTERAZORHELPINDENTATION "Gedeeltelijke overlapping is nodig om een marge te krijgen voor de onnodige marge aan een kant. Hetgeeft ook wat meer ruimte om de verschillende vellen te verlijmen. " POSTERAZORHELPENDLINE \
					POSTERAZORHELPINDENTATION "De <b>Overlappende zijden</b> geven de hoeken aan die door het naastliggende bedekt worden. De tegenoverliggende randen van de opvolgende vellen dienen te worden afgesneden of -geknipt (zonder de buitenmarge dus)." POSTERAZORHELPENDLINE \
					...
					"<LI><b>Grootte in percentage</b>: een afbeelding heeft een zekere grootte, afhankelijk van de pixels en DPI (dots per Inch)en deze moet vergroot worden met een zekere factor.</LI>" POSTERAZORHELPENDLINE \
					"</UL>" POSTERAZORHELPENDLINE \
					...
					POSTERAZORHELPINDENTATION "Sla de poster op door te klikken op de brede knop en het ingeven van een nieuwe, voor opslag geschikte bestandsnaam. Vink <b>De PDF-applicatie opstarten.. </b> aan als de voor het besturingssysteem tot standaard gemaakte applicatie gestart moet worden met het PDF bestand dat zojuist is opgeslagen." POSTERAZORHELPENDLINE \

					POSTERAZORHELPSECTIONHEADER(POSTERAZORHELPANCHORINPUTFILEFORMATS, ENGLISH_POSTERAZORHELPINPUTFILEFORMATS) \
					POSTERAZORHELPINDENTATION "De meeste rasterformaten die ondersteund worden bij FreeImage worden ook ondersteund in PosteRazor:<br>" POSTERAZORHELPENDLINE \
					...
					"PosteRazor distinguishes and handles monochrome, greyscale, 4-bit palette, 8-bit palette, 24 bit RGB, and CMYK (only from TIF) images. RGB afbeeldingen met een alpha kanaal worden automatisch geconverteerd en getoond op een witte achtergrond." POSTERAZORHELPENDLINE \

					POSTERAZORHELPSECTIONHEADER(POSTERAZORHELPANCHORWHYPDFOUTPUT, DUTCH_POSTERAZORHELPWHYPDFOUTPUT) \
					POSTERAZORHELPINDENTATION "Waarom een  PDF bestand en niet direct printen? Allereerst weet de ontwerper van dit programma nog niet hoe dit \"send images to the printer\" werkt op verschillende platformen en operating systems waar PosteRazor voor is bedoeld. Maar, PDF maakt wel indruk als het poster thuis “gerazored” is en als PDF bestand meegenomen wordt naar het werk om daar op de kleuren laserprinter wordt uitgedraaid (en natuurlijk iedereen al naar huis is…)." POSTERAZORHELPENDLINE \
					POSTERAZORHELPINDENTATION "Waarom een PDF en geen andere formaten als eindresultaat? PDF geeft de mogelijkheid om meer dan de benodigde gegevens in een bestand op te slaan. PDF geeft ook nog eens de mogelijkheid om hele bestanden op te nemen en virtueel te delen. Niet alleen in pixels maar ook in fracties van pixels. Ook is het printen van een uit meerdere pagina’s bestaand PDF bestand handiger in plaats van meerdere losse afbeeldingen." POSTERAZORHELPENDLINE \

					POSTERAZORHELPSECTIONHEADER(POSTERAZORHELPANCHORCODEFROMTHIRDPARTIES, ENGLISH_POSTERAZORHELPCODEFROMTHIRDPARTIES) \
					"<UL>" POSTERAZORHELPENDLINE \
					"<LI><b>FLTK</b> wordt gebruikt in de gebruikersinterface. Het is klein (in opslag), snel, leuk & eenvoudig te leren en bijzonder uitwisselbare UI Toolkit. <a href=\"http://www.fltk.org/\">www.fltk.org</a></LI>" POSTERAZORHELPENDLINE \
					"<LI><b>FreeImage</b> wordt gebruikt voor de grafische afhandeling. Het maakt het  tonen van bestanden en  een grafische weergave simpel en is uitwisselbaar op meerdere platformen waar PosteRazor ook op werkt. <a href=\"http://freeimage.sourceforge.net/\">FreeImage website</a></LI>" POSTERAZORHELPENDLINE \
					"<LI><b>Fl_Native_File_Chooser</b> wordt gebruikt voor het openen en opslaan van bestanden in de vertrouwde \"look and feel\" stijl. <a href=\"http://seriss.com/people/erco/fltk/Fl_Native_File_Chooser/\">Fl_Native_File_Chooser website</a></LI>" POSTERAZORHELPENDLINE \
					"</UL>" POSTERAZORHELPENDLINE \
