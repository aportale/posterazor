...
convert %SOURCE% %PARAMETERS% -monochrome monochrome.tif
convert %SOURCE% %PARAMETERS% -colors 2 palette1bpp.tif
convert %SOURCE% %PARAMETERS% -colors 4 palette2bpp.tif
convert %SOURCE% %PARAMETERS% -colors 16 palette4bpp.tif
convert %SOURCE% %PARAMETERS% -colors 256 palette8bpp.tif
convert %SOURCE% %PARAMETERS% -depth 8 rgb24bpp.tif
convert %SOURCE% %PARAMETERS% -depth 16 rgb48bpp.tif
convert %SOURCE% %PARAMETERS% -depth 8 -matte -fill none -fuzz 50% -draw "matte 5,5 floodfill" rgba32bpp.png
convert %SOURCE% %PARAMETERS% -depth 16 -matte -fill none -fuzz 50% -draw "matte 5,5 floodfill" rgba64bpp.tif
